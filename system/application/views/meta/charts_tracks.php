...
<li><a  class='active' href='<?php echo site_url('meta/charts/tracks'); ?>'>Tracks</a></li>
...
for($i=0; $i<10; $i++)
{
	echo "<li><span class='rank'>".($i+1)."</span><span class='name'>\"".$charts['songs'][$i]['title']."\" <span class='gray'> /// ".$charts['songs'][$i]['artist']."</span></span></li>";
}
?>
</ul>
