...
class Podcasting extends Model {
    ...
    /**
    *	Generates tables for handling podcasts. Run once. Supposed to not 
    *	overwrite tables, but nonetheless, run only once.
    */
    ...
    *	the duration fields for you (you must commit the changes using 
    *	add_podcast_entry) it will not automatically determine file 
    *	duration
    */
